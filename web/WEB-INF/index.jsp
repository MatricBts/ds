    ...
    <body>
        ...
        <%
            try{
                ...
                if(request.getParameter("") == "" || request.getParameter("") == "" ){ // se for em branco aparecerá a tabela completa
                    ...
                    for(int num = 0; num < lista.size(); num++){
                        ...
                        out.print("<td><a href='alterar.jsp?codigo="+lista.get(num).getCodigo_produto()+"&descricao="+lista.get(num).getDescricao_produto()+" '>CLIQUE</a></td>");
                        out.print("<tr>");
                    }
                } else {
